...
(function() {
  $(function() {
    var parseProfessorData, professors;
    professors = new Bloodhound({
      ...
      prefetch: {
        ...
        filter: function(list) {
          return $.map(list, function(professor) {
    ...
    parseProfessorData = function(data) {
      var course_index_mapper, courses, map_i, rendered, result_container, template;
      ...
      course_index_mapper = {};
      map_i = 0;
      $.each(data.sections, function(i, val) {
        var course_id;
        ...
        delete val.course;
        return courses[course_id].sections.push(val);
      });
      ...
      console.log(data);
      return result_container.empty().html(rendered);
    };
    return $('.typeahead').on('typeahead:selected', function(obj, datum, name) {
      return $.get('/professors/' + datum.id + '.json', parseProfessorData);
    });
  });
